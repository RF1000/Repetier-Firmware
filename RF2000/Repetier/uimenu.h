...
#if NUM_EXTRUDER == 2
UI_MENU_CHANGEACTION_FILTER(ui_menu_extruders,UI_TEXT_EXTRUDERS,UI_ACTION_EXTRUDERS,MENU_MODE_PRINTER,0);
#define EXTRUDERS_COUNT	1
#define EXTRUDERS_ENTRY	,&ui_menu_extruders
#else
#define EXTRUDERS_COUNT	0
#define EXTRUDERS_ENTRY
#endif // NUM_EXTRUDER == 2
#else
#define EXTRUDERS_COUNT	0
#define EXTRUDERS_ENTRY
...
#define UI_MENU_GENERAL {UI_MENU_ADDCONDBACK &ui_menu_general_baud,&ui_menu_general_stepper_inactive,&ui_menu_general_max_inactive BEEPER_MODE_ENTRY LIGHT_MODE_ENTRY OPERATING_MODE_ENTRY EXTRUDERS_ENTRY,&ui_menu_z_mode Z_ENDSTOP_TYPE_ENTRY HOTEND_TYPE_ENTRY MILLER_TYPE_ENTRY EXTRUDER_OFFSET_TYPE_ENTRY_X EXTRUDER_OFFSET_TYPE_ENTRY_Y}
UI_MENU(ui_menu_general,UI_MENU_GENERAL,4+UI_MENU_BACKCNT+BEEPER_MODE_COUNT+LIGHT_MODE_COUNT+OPERATING_MODE_COUNT+EXTRUDERS_COUNT+Z_ENDSTOP_TYPE_COUNT+HOTEND_TYPE_COUNT+MILLER_TYPE_COUNT+EXTRUDER_OFFSET_TYPE_COUNT_XY);
