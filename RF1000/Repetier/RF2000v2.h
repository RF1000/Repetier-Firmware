...
#define Z_MAX_LENGTH						(long)185
#else
#define X_MAX_LENGTH_PRINT					(long)215
#define X_MAX_LENGTH_OFFSET					(long) 30
#define X_MAX_LENGTH_MILL					(long)200
#define Y_MAX_LENGTH						(long)290
#define Z_MAX_LENGTH						(long)185
...
#define EXT1_X_OFFSET						(33.6 * XAXIS_STEPS_PER_MM)		// [steps]
#define EXT1_Y_OFFSET						( 0.0 * YAXIS_STEPS_PER_MM)		// [steps]

/** \brief for skeinforge 40 and later, steps to pull the plasic 1 mm inside the extruder, not out.  Overridden if EEPROM activated. */
#define EXT1_STEPS_PER_MM					(8.0 * RF_MICRO_STEPS)
...
#define	COOLER_KICKSTART_THRESHOLD		  144	// COOLER_PWM_MIN ... COOLER_PWM_MAX equals 0 ... 100 %
