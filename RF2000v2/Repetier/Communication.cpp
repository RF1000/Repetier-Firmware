...
FSTRINGVALUE(Com::tEPRExtruders,"Extruders [0=L,1=R,2=D]")
...
FSTRINGVALUE(Com::tEPRSensorType,"sensor type [3=Bed/V1/V2, 13=V3]")
...
FSTRINGVALUE(Com::tEPRHotendType,"Hotend type [2=V1, 3=V2 single, 4=V2 dual, 5=V3]")
